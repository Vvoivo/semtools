...
use crate::api::conversions::json::payload_to_proto;
use crate::api::rest::{
...
impl TryFrom<BatchPersisted> for Vec<crate::api::grpc::qdrant::PointStruct> {
    type Error = Status;
    ...
    fn try_from(batch: BatchPersisted) -> Result<Self, Self::Error> {
        ...
        for (i, p_id) in ids.into_iter().enumerate() {
            ...
            let point = crate::api::grpc::qdrant::PointStruct {
                id,
                vectors: vectors.map(crate::api::grpc::qdrant::Vectors::from),
...
impl TryFrom<crate::api::rest::schema::Record> for PointStructPersisted {
    type Error = String;

    fn try_from(record: crate::api::rest::schema::Record) -> Result<Self, Self::Error> {
        let crate::api::rest::schema::Record {
            id,
            payload,
            vector,
            shard_key: _,
...
impl TryFrom<PointStructPersisted> for crate::api::grpc::qdrant::PointStruct {
    type Error = Status;
    ...
    fn try_from(value: PointStructPersisted) -> Result<Self, Self::Error> {
        ...
        let vectors = crate::api::grpc::qdrant::Vectors::from(vectors_internal);
