...
use crate::segment::types::{PayloadFieldSchema, PointIdType};
...
impl From<crate::api::grpc::qdrant::ClockTag> for ClockTag {
    fn from(tag: crate::api::grpc::qdrant::ClockTag) -> Self {
        let crate::api::grpc::qdrant::ClockTag {
            peer_id,
            clock_id,
            clock_tick,
            token,
...
impl From<ClockTag> for crate::api::grpc::qdrant::ClockTag {
