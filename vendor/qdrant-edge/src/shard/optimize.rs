...
use crate::common::bytes::bytes_to_human;
use crate::common::counter::hardware_counter::HardwareCounterCell;
use crate::common::disk::dir_disk_size;
use crate::common::progress_tracker::ProgressTracker;
use crate::common::storage_version::StorageVersion;
use fs_err as fs;
use itertools::Itertools;
use parking_lot::{Mutex, RwLockUpgradableReadGuard};
use crate::segment::common::operation_error::{OperationResult, check_process_stopped};
use crate::segment::common::operation_time_statistics::{
    OperationDurationsAggregator, ScopeDurationMeasurer,
};
use crate::segment::entry::NonAppendableSegmentEntry;
...
use crate::shard::proxy_segment::{DeletedPoints, ProxyIndexChange, ProxyIndexChanges, ProxySegment};
...
fn build_new_segment<F: ?Sized + OptimizationStrategy>(
    ...
    let indexing_permit = resource_budget
        ...
        .map_err(|_| {
            crate::segment::common::operation_error::OperationError::cancelled(
...
fn check_segments_size(
    ...
    for segment in optimizing_segments {
        match segment {
            ...
            LockedSegment::Proxy(_) => {
                return Err(
                    crate::segment::common::operation_error::OperationError::service_error(
