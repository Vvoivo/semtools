...
use crate::shard::operations::FieldIndexOperations;
...
use crate::shard::operations::vector_ops::{PointVectorsPersisted, UpdateVectorsOp, VectorOperations};
...
mod test {
    ...
    use crate::segment::types::{Condition, FieldCondition, Filter, Match, MatchValue, ValueVariants};
    use tempfile::Builder;

    use crate::shard::fixtures::{build_segment_1, build_segment_2};
    use crate::shard::segment_holder::SegmentHolder;
    use crate::shard::update::delete_points_by_filter;
