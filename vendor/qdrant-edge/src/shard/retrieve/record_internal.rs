...
use crate::api::grpc::conversions::convert_shard_key_to_grpc;
...
impl From<RecordInternal> for crate::api::grpc::qdrant::RetrievedPoint {
    fn from(record: RecordInternal) -> Self {
        ...
        Self {
            ...
            vectors: vector.map(crate::api::grpc::qdrant::VectorsOutput::from),
...
impl From<RecordInternal> for crate::api::rest::Record {
    fn from(value: RecordInternal) -> Self {
        ...
        Self {
            id,
            payload,
            vector: vector.map(crate::api::rest::VectorStructOutput::from),
            shard_key,
            order_value,
        }
    }
