...
use crate::segment::vector_storage::dense::appendable_dense_vector_storage::AppendableMmapDenseVectorStorage;
#[cfg(feature = "rocksdb")]
use crate::segment::vector_storage::sparse::simple_sparse_vector_storage::SimpleSparseVectorStorage;
...
impl VectorStorage for VectorStorageEnum {
    ...
    fn read_vectors<P: AccessPattern>(
        ...
        match self {
            #[cfg(feature = "rocksdb")]
            VectorStorageEnum::DenseSimple(v) => v.read_vectors::<P>(keys, callback),
            #[cfg(feature = "rocksdb")]
            ...
            #[cfg(feature = "rocksdb")]
            VectorStorageEnum::MultiDenseSimple(v) => v.read_vectors::<P>(keys, callback),
            #[cfg(feature = "rocksdb")]
