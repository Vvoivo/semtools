...
use crate::common::fs::{atomic_save_json, clear_disk_cache, read_json};
use crate::common::types::PointOffsetType;
use crate::quantization::encoded_vectors_binary::EncodedVectorsBin;
use crate::quantization::encoded_vectors_u8::ScalarQuantizationMethod;
use crate::quantization::{EncodedVectors, EncodedVectorsPQ, EncodedVectorsU8};
...
use crate::segment::data_types::vectors::{QueryVector, VectorElementType, VectorRef};
...
use crate::segment::vector_storage::quantized::quantized_chunked_mmap_storage::{
    QuantizedChunkedMmapStorage, QuantizedChunkedMmapStorageBuilder,
};
use crate::segment::vector_storage::quantized::quantized_mmap_storage::{
...
use crate::segment::vector_storage::quantized::quantized_query_scorer::{
    InternalScorerUnsupported, QuantizedQueryScorer,
};
use crate::segment::vector_storage::quantized::quantized_ram_storage::{
...
pub struct QuantizedVectorsConfig {
    ...
    pub vector_parameters: crate::quantization::VectorParameters,
    #[serde(default)]
...
impl QuantizedVectors {
    ...
    pub fn raw_internal_scorer<'a>(
        ...
        fn build<'a, TEncodedVectors: crate::quantization::EncodedVectors>(
            point_id: PointOffsetType,
    ...
    pub fn load(
        ...
        if !crate::common::flags::feature_flags().appendable_quantization {
            return Ok(None);
        }
    ...
    fn create_scalar<'a>(
        ...
        vector_parameters: &crate::quantization::VectorParameters,
        vectors_count: usize,
        scalar_config: &ScalarQuantizationConfig,
        storage_type: QuantizedVectorsStorageType,
        path: &Path,
    ...
    ) -> crate::quantization::encoded_vectors_binary::Encoding {
        match encoding {
            Some(BinaryQuantizationEncoding::OneBit) => {
                crate::quantization::encoded_vectors_binary::Encoding::OneBit
            }
            Some(BinaryQuantizationEncoding::TwoBits) => {
                crate::quantization::encoded_vectors_binary::Encoding::TwoBits
            }
            Some(BinaryQuantizationEncoding::OneAndHalfBits) => {
                crate::quantization::encoded_vectors_binary::Encoding::OneAndHalfBits
            }
            None => crate::quantization::encoded_vectors_binary::Encoding::OneBit,
        }
    }

    fn convert_binary_query_encoding(
        query_encoding: Option<BinaryQuantizationQueryEncoding>,
    ) -> crate::quantization::encoded_vectors_binary::QueryEncoding {
        match query_encoding {
            Some(BinaryQuantizationQueryEncoding::Scalar4Bits) => {
                crate::quantization::encoded_vectors_binary::QueryEncoding::Scalar4bits
            }
            Some(BinaryQuantizationQueryEncoding::Scalar8Bits) => {
                crate::quantization::encoded_vectors_binary::QueryEncoding::Scalar8bits
            }
            Some(BinaryQuantizationQueryEncoding::Binary) => {
                crate::quantization::encoded_vectors_binary::QueryEncoding::SameAsStorage
            }
            Some(BinaryQuantizationQueryEncoding::Default) => {
                crate::quantization::encoded_vectors_binary::QueryEncoding::SameAsStorage
            }
            None => crate::quantization::encoded_vectors_binary::QueryEncoding::SameAsStorage,
        }
    }
    ...
    fn construct_vector_parameters(
        ...
        storage_type: QuantizedVectorsStorageType,
    ) -> crate::quantization::VectorParameters {
        crate::quantization::VectorParameters {
            dim,
            ...
            distance_type: match distance {
                Distance::Cosine => crate::quantization::DistanceType::Dot,
                Distance::Euclid => crate::quantization::DistanceType::L2,
                Distance::Dot => crate::quantization::DistanceType::Dot,
                Distance::Manhattan => crate::quantization::DistanceType::L1,
            },
    ...
    fn upsert_vector_dense(
        quantization_storage: &mut impl crate::quantization::EncodedVectors,
        id: PointOffsetType,
        vector: VectorRef,
        hw_counter: &HardwareCounterCell,
    ) -> OperationResult<()> {
