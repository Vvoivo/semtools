...
use crate::common::mmap::{Advice, AdviceSetting, MmapFlusher};
...
use crate::segment::vector_storage::{Random, VectorOffsetType};
...
impl crate::quantization::EncodedStorage for QuantizedChunkedMmapStorage {
    ...
    fn upsert_vector(
        ...
        id: PointOffsetType,
        vector: &[u8],
        hw_counter: &crate::common::counter::hardware_counter::HardwareCounterCell,
    ) -> std::io::Result<()> {
        self.data
...
impl crate::quantization::EncodedStorageBuilder for QuantizedChunkedMmapStorageBuilder {
