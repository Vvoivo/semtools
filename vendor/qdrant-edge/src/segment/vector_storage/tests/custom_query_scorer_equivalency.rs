...
use crate::segment::data_types::vectors::{QueryVector, VectorElementType};
use crate::segment::fixtures::payload_context_fixture::create_id_tracker_fixture;
use crate::segment::fixtures::query_fixtures::QueryVariant;
...
#[cfg(target_os = "linux")]
use crate::segment::vector_storage::dense::memmap_dense_vector_storage::open_memmap_vector_storage_with_async_io;
...
use crate::segment::vector_storage::vector_storage_base::VectorStorage;
use crate::segment::vector_storage::{Random, VectorStorageEnum};
...
fn random_query<R: Rng + ?Sized>(
    ...
    crate::segment::fixtures::query_fixtures::random_query(query_variant, rng, |rng| {
...
fn scalar_u8() -> WithQuantization {
    let config = ScalarQuantizationConfig {
        r#type: crate::segment::types::ScalarType::Int8,
        quantile: Some(0.5),
...
fn product_x4() -> WithQuantization {
    let config = ProductQuantizationConfig {
        compression: crate::segment::types::CompressionRatio::X4,
        always_ram: Some(true),
    }
    .into();
