...
use crate::common::validation::MAX_MULTIVECTOR_FLATTENED_LEN;
use rstest::rstest;
...
use crate::segment::types::{Distance, MultiVectorConfig};
use crate::segment::vector_storage::common::CHUNK_SIZE;
use crate::segment::vector_storage::multi_dense::appendable_mmap_multi_dense_vector_storage::open_appendable_memmap_multi_vector_storage_full;
...
fn create_vector_storage(
    ...
    match storage_type {
        ...
        MultiDenseStorageType::RocksDbFloat => {
            ...
            use crate::segment::vector_storage::multi_dense::simple_multi_dense_vector_storage::open_simple_multi_dense_vector_storage_full;
