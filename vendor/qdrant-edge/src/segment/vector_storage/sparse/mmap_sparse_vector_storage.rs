...
use fs_err as fs;
use crate::gridstore::Gridstore;
use crate::gridstore::config::{Compression, StorageOptions};
use crate::sparse::common::sparse_vector::SparseVector;

use crate::segment::common::flags::bitvec_flags::BitvecFlags;
use crate::segment::common::flags::dynamic_mmap_flags::DynamicMmapFlags;
...
use crate::segment::vector_storage::{AccessPattern, SparseVectorStorage, VectorStorage};
...
impl VectorStorage for MmapSparseVectorStorage {
    fn distance(&self) -> crate::segment::types::Distance {
        super::SPARSE_VECTOR_DISTANCE
    }

    fn datatype(&self) -> crate::segment::types::VectorStorageDatatype {
    ...
    fn delete_vector(
        &mut self,
        key: crate::common::types::PointOffsetType,
    ) -> crate::segment::common::operation_error::OperationResult<bool> {
    ...
    fn is_deleted_vector(&self, key: crate::common::types::PointOffsetType) -> bool {
...
pub(crate) fn find_storage_files(vector_storage_path: &Path) -> OperationResult<Vec<PathBuf>> {
    ...
    let mut files = vec![];
    files.extend(crate::common::disk::list_files(&storage_path)?);
    files.extend(crate::common::disk::list_files(&deleted_path)?);
    Ok(files)
}
...
mod test {
    ...
    use crate::sparse::common::sparse_vector;
    ...
    use crate::segment::vector_storage::{Random, VectorStorage};
    ...
    fn test_create_insert_close_and_load() {
        ...
        match result_vector {
            crate::segment::data_types::named_vectors::CowVector::Sparse(sparse) => {
