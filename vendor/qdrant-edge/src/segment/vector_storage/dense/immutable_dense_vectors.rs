...
use crate::common::maybe_uninit::maybe_uninit_fill_from;
use crate::common::mmap;
use crate::common::mmap::{AdviceSetting, MmapBitSlice, MmapFlusher};
use crate::common::types::PointOffsetType;
use crate::common::universal_io::mmap::MmapUniversal;
use crate::common::universal_io::{ElementsRange, OpenOptions as UniversalOpenOptions, UniversalRead};
...
#[cfg(target_os = "linux")]
use crate::segment::vector_storage::async_io::UringReader;
#[cfg(not(target_os = "linux"))]
use crate::segment::vector_storage::async_io_mock::UringReader;
use crate::segment::vector_storage::common::VECTOR_READ_BATCH_SIZE;
use crate::segment::vector_storage::query_scorer::is_read_with_prefetch_efficient;
use crate::segment::vector_storage::{AccessPattern, Random, Sequential};
...
impl<T: PrimitiveVectorElement, S: UniversalRead<u8>> ImmutableDenseVectors<T, S> {
    pub fn open(
        ...
        let storage = UniversalRead::<u8>::open(vectors_path, options).map_err(|e| {
            crate::segment::common::operation_error::OperationError::service_error(format!(
