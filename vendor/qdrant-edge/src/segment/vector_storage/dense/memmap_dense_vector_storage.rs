...
use crate::common::universal_io::mmap::MmapUniversal;
use fs_err as fs;
...
use crate::segment::data_types::vectors::{VectorElementType, VectorRef};
use crate::segment::types::{Distance, VectorStorageDatatype};
use crate::segment::vector_storage::common::get_async_scorer;
use crate::segment::vector_storage::dense::immutable_dense_vectors::ImmutableDenseVectors;
use crate::segment::vector_storage::{AccessPattern, DenseVectorStorage, VectorStorage, VectorStorageEnum};
...
mod tests {
    ...
    use crate::common::counter::hardware_counter::HardwareCounterCell;
    #[expect(deprecated, reason = "legacy code")]
    use crate::common::mmap::transmute_to_u8_slice;
    use itertools::Itertools;
    use tempfile::Builder;

    use super::*;
    use crate::segment::data_types::vectors::{DenseVector, QueryVector};
    use crate::segment::fixtures::payload_context_fixture::create_id_tracker_fixture;
    use crate::segment::id_tracker::IdTracker;
    use crate::segment::index::hnsw_index::point_scorer::{BatchFilteredSearcher, FilteredScorer};
    use crate::segment::types::{PointIdType, QuantizationConfig, ScalarQuantizationConfig};
    ...
    use crate::segment::vector_storage::{DEFAULT_STOPPED, Random, new_raw_scorer};
