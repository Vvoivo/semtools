...
use crate::common::fs::{atomic_save_json, clear_disk_cache};
...
use crate::segment::vector_storage::common::{CHUNK_SIZE, PAGE_SIZE_BYTES, VECTOR_READ_BATCH_SIZE};
use crate::segment::vector_storage::query_scorer::is_read_with_prefetch_efficient;
use crate::segment::vector_storage::{AccessPattern, VectorOffset, VectorOffsetType};
...
pub fn read_chunks<T: Sized + Copy + 'static, S: UniversalWrite<T>>(
    ...
    advice: AdviceSetting,
    populate: bool,
) -> Result<Vec<S>, crate::common::universal_io::UniversalIoError> {
