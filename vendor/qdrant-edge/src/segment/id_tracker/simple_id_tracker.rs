...
use crate::segment::common::rocksdb_wrapper::{DB_MAPPING_CF, DB_VERSIONS_CF, DatabaseColumnWrapper};
...
mod tests {
    ...
    use super::*;
    use crate::segment::common::rocksdb_wrapper::open_db;
    use crate::segment::segment_constructor::migrate_rocksdb_id_tracker_to_mutable;
