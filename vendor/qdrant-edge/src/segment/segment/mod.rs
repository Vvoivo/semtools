...
use crate::segment::common::operation_error::SegmentFailedState;
...
use crate::segment::types::{SegmentConfig, SegmentType, SeqNumberType, VectorNameBuf};
...
pub fn destroy_rocksdb(
    path: &std::path::Path,
) -> crate::segment::common::operation_error::OperationResult<()> {
