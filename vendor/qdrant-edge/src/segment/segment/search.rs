...
use crate::common::types::ScoredPointOffset;
...
use crate::segment::data_types::vectors::VectorStructInternal;
...
use crate::segment::types::{ScoredPoint, WithPayload, WithVector};
