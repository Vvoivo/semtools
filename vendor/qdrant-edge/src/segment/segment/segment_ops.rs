...
use crate::common::tar_unpack::tar_unpack_file;
...
use crate::segment::common::{check_named_vectors, check_vector_name};
use crate::segment::data_types::named_vectors::NamedVectors;
use crate::segment::data_types::vectors::VectorInternal;
use crate::segment::entry::entry_point::NonAppendableSegmentEntry;
...
fn unpack_snapshot(segment_path: &Path) -> OperationResult<()> {
    #[cfg(feature = "rocksdb")]
    {
        ...
        if db_backup_path.is_dir() {
            crate::segment::rocksdb_backup::restore(&db_backup_path, segment_path)?;
