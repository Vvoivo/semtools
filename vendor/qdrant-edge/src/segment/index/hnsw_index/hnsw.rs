...
use crate::common::cow::BoxCow;
#[cfg(target_os = "linux")]
use crate::common::cpu::linux_low_thread_priority;
use crate::common::ext::BitSliceExt as _;
...
#[cfg(feature = "gpu")]
use crate::segment::index::hnsw_index::gpu::gpu_graph_builder::GPU_MAX_VISITED_FLAGS_FACTOR;
#[cfg(feature = "gpu")]
use crate::segment::index::hnsw_index::gpu::{get_gpu_groups_count, gpu_graph_builder::build_hnsw_on_gpu};
use crate::segment::index::hnsw_index::graph_layers::{
    GraphLayers, GraphLayersWithVectors, SearchAlgorithm,
};
use crate::segment::index::hnsw_index::graph_layers_builder::GraphLayersBuilder;
use crate::segment::index::hnsw_index::graph_layers_healer::GraphLayersHealer;
use crate::segment::index::hnsw_index::graph_links::{GraphLinksFormatParam, StorageGraphLinksVectors};
use crate::segment::index::hnsw_index::point_scorer::FilteredScorer;
use crate::segment::index::query_estimator::adjust_to_available_vectors;
use crate::segment::index::sample_estimation::sample_check_cardinality;
...
use crate::segment::index::{PayloadIndex, VectorIndex, VectorIndexEnum};
use crate::segment::json_path::JsonPath;
use crate::segment::payload_storage::FilterContext;
use crate::segment::segment_constructor::VectorIndexBuildArgs;
use crate::segment::telemetry::VectorIndexSearchesTelemetry;
use crate::segment::types::Condition::Field;
...
use crate::segment::vector_storage::query::DiscoveryQuery;
use crate::segment::vector_storage::{VectorStorage, VectorStorageEnum, new_raw_scorer};
...
impl HNSWIndex {
    ...
    fn create_gpu_vectors(
        ...
        use crate::segment::index::hnsw_index::gpu::get_gpu_force_half_precision;
