...
use crate::segment::data_types::facets::{FacetHit, FacetValueRef};
...
impl BoolIndex {
    ...
    pub fn get_storage_type(&self) -> StorageType {
        match self {
            #[cfg(feature = "rocksdb")]
            BoolIndex::Simple(_) => crate::segment::index::payload_config::StorageType::RocksDb,
...
impl PayloadFieldIndex for BoolIndex {
    ...
    fn filter<'a>(
        &'a self,
        condition: &'a crate::segment::types::FieldCondition,
    ...
    fn estimate_cardinality(
        &self,
        condition: &crate::segment::types::FieldCondition,
...
mod tests {
    ...
    use crate::segment::index::field_index::{FieldIndexBuilderTrait as _, PayloadFieldIndex, ValueIndexer};
