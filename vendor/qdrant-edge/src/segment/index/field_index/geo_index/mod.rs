...
use crate::segment::index::field_index::geo_hash::{
...
use crate::segment::types::{FieldCondition, GeoPoint, PayloadKeyType};
...
mod tests {
    ...
    use crate::segment::fixtures::payload_fixtures::random_geo_payload;
    use crate::segment::json_path::JsonPath;
    use crate::segment::types::test_utils::build_polygon;
    use crate::segment::types::{GeoBoundingBox, GeoLineString, GeoPolygon, GeoRadius};
