...
use crate::segment::data_types::index::{TextIndexParams, TokenizerType};
...
mod tests {
    ...
    fn test_tokenizer_with_language_stopwords() {
        use crate::segment::data_types::index::Language;
    ...
    fn test_tokenizer_can_handle_apostrophes_parametrized() {
        use crate::segment::data_types::index::TokenizerType;
