...
#[cfg(feature = "rocksdb")]
use crate::segment::common::rocksdb_wrapper::open_db_with_existing_cf;
use crate::segment::data_types::index::TextIndexParams;
use crate::segment::fixtures::payload_fixtures::random_full_text_payload;
use crate::segment::index::field_index::field_index_base::PayloadFieldIndex;
use crate::segment::index::field_index::full_text_index::inverted_index::{
    Document, InvertedIndex, ParsedQuery, TokenId, TokenSet,
};
use crate::segment::index::field_index::full_text_index::mmap_text_index::FullTextMmapIndexBuilder;
use crate::segment::index::field_index::full_text_index::mutable_text_index::MutableFullTextIndex;
#[cfg(feature = "rocksdb")]
use crate::segment::index::field_index::full_text_index::text_index::FullTextIndexRocksDbBuilder;
use crate::segment::index::field_index::full_text_index::text_index::{
    FullTextGridstoreIndexBuilder, FullTextIndex,
};
use crate::segment::index::field_index::{FieldIndexBuilderTrait, ValueIndexer};
use crate::segment::json_path::JsonPath;
use crate::segment::types::{FieldCondition, ValuesCount};
