...
use crate::posting_list::{PostingBuilder, PostingList, PostingListView, PostingValue};
...
pub struct ImmutableInvertedIndex {
    pub(in crate::segment::index::field_index::full_text_index) postings: ImmutablePostings,
    pub(in crate::segment::index::field_index::full_text_index) vocab: HashMap<String, TokenId>,
    pub(in crate::segment::index::field_index::full_text_index) point_to_tokens_count: Vec<usize>,
    pub(in crate::segment::index::field_index::full_text_index) points_count: usize,
}
