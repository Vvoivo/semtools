...
use crate::common::mmap::{Advice, AdviceSetting, Madviseable, open_read_mmap};
use crate::common::types::PointOffsetType;
use crate::common::zeros::WriteZerosExt;
use fs_err::File;
use memmap2::Mmap;
use crate::posting_list::{
...
use crate::segment::index::field_index::full_text_index::inverted_index::TokenId;
use crate::segment::index::field_index::full_text_index::inverted_index::positions::Positions;

const ALIGNMENT: usize = 4;

/// Trait marker to enrich [`posting_list::PostingValue`] for handling mmap files with the posting list.
pub(in crate::segment::index::field_index::full_text_index) trait MmapPostingValue:
    PostingValue<
...
#[derive(Debug, Default, Clone, FromBytes, Immutable, IntoBytes, KnownLayout)]
#[repr(C)]
pub(in crate::segment::index::field_index::full_text_index) struct PostingListHeader {
