...
use crate::common::mmap::{AdviceSetting, MmapBitSlice, MmapSlice};
use crate::common::mmap_hashmap::{MmapHashMap, READ_ENTRY_OVERHEAD};
...
use crate::segment::common::mmap_bitslice_buffered_update_wrapper::MmapBitSliceBufferedUpdateWrapper;
use crate::segment::common::operation_error::{OperationError, OperationResult};
use crate::segment::index::field_index::full_text_index::inverted_index::Document;
use crate::segment::index::field_index::full_text_index::inverted_index::postings_iterator::{
...
pub struct MmapInvertedIndex {
    pub(in crate::segment::index::field_index::full_text_index) path: PathBuf,
    pub(in crate::segment::index::field_index::full_text_index) storage: Storage,
    /// Number of points which are not deleted
    pub(in crate::segment::index::field_index::full_text_index) active_points_count: usize,
    is_on_disk: bool,
}

pub(in crate::segment::index::field_index::full_text_index) struct Storage {
    pub(in crate::segment::index::field_index::full_text_index) postings: MmapPostingsEnum,
    pub(in crate::segment::index::field_index::full_text_index) vocab: MmapHashMap<str, TokenId>,
    pub(in crate::segment::index::field_index::full_text_index) point_to_tokens_count: MmapSlice<usize>,
    pub(in crate::segment::index::field_index::full_text_index) deleted_points:
