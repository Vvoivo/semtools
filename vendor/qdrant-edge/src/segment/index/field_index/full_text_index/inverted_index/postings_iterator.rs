...
use crate::posting_list::{PostingIterator, PostingListView, PostingValue};

use super::posting_list::PostingList;
use crate::segment::index::field_index::full_text_index::inverted_index::positions::{
    PartialDocument, Positions, TokenPosition,
};
use crate::segment::index::field_index::full_text_index::inverted_index::{Document, TokenId};
...
mod tests {
    ...
    use crate::posting_list::IdsPostingList;
