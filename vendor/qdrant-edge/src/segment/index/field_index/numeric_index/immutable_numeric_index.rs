...
#[cfg(feature = "rocksdb")]
use crate::segment::common::rocksdb_buffered_delete_wrapper::DatabaseColumnScheduledDeleteWrapper;
#[cfg(feature = "rocksdb")]
use crate::segment::common::rocksdb_wrapper::DatabaseColumnWrapper;
use crate::segment::index::field_index::histogram::{Histogram, Numericable, Point};
use crate::segment::index::field_index::immutable_point_to_values::ImmutablePointToValues;
use crate::segment::index::field_index::mmap_point_to_values::MmapValue;
    ...
    Vec<T>: Blob,
{
    ...
    pub(super) fn open_rocksdb(db: Arc<RwLock<DB>>, field: &str) -> OperationResult<Option<Self>> {
        use crate::segment::index::field_index::numeric_index::mutable_numeric_index::MutableNumericIndex;
...
mod tests {
    ...
    use super::*;
    use crate::segment::types::FloatPayloadType;
