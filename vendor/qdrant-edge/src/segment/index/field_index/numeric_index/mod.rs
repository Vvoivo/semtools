...
use crate::segment::index::field_index::histogram::{Histogram, Numericable};
...
use crate::segment::index::key_encoding::{
...
impl<T: Encodable + Numericable> Range<T> {
    pub(in crate::segment::index::field_index::numeric_index) fn as_index_key_bounds(
        &self,
