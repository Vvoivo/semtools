...
#[cfg(feature = "rocksdb")]
use crate::segment::id_tracker::simple_id_tracker::SimpleIdTracker;
...
#[cfg(feature = "rocksdb")]
use crate::segment::payload_storage::on_disk_payload_storage::OnDiskPayloadStorage;
use crate::segment::payload_storage::payload_storage_enum::PayloadStorageEnum;
#[cfg(feature = "rocksdb")]
use crate::segment::payload_storage::simple_payload_storage::SimplePayloadStorage;
use crate::segment::segment::{SEGMENT_STATE_FILE, Segment, SegmentVersion, VectorData};
#[cfg(feature = "rocksdb")]
use crate::segment::types::MultiVectorConfig;
...
use crate::segment::vector_storage::dense::memmap_dense_vector_storage::{
    open_memmap_vector_storage, open_memmap_vector_storage_byte, open_memmap_vector_storage_half,
};
#[cfg(feature = "rocksdb")]
use crate::segment::vector_storage::dense::simple_dense_vector_storage::open_simple_dense_vector_storage;
...
#[cfg(feature = "rocksdb")]
use crate::segment::vector_storage::multi_dense::simple_multi_dense_vector_storage::open_simple_multi_dense_vector_storage;
...
use crate::segment::vector_storage::{VectorStorage, VectorStorageEnum};
...
pub(crate) fn open_vector_storage(
    ...
    match vector_config.storage_type {
        ...
        VectorStorageType::Memory => {
            let storage_element_type = vector_config.datatype.unwrap_or_default();
            use crate::segment::common::rocksdb_wrapper::DB_VECTOR_CF;
...
pub(crate) fn create_sparse_vector_storage(
    ...
    match storage_type {
        ...
        SparseVectorStorageType::OnDisk => {
            use crate::segment::common::rocksdb_wrapper::DB_VECTOR_CF;
            use crate::segment::vector_storage::sparse::simple_sparse_vector_storage::open_simple_sparse_vector_storage;
...
fn create_segment_id_tracker(
    ...
    #[cfg(feature = "rocksdb")]
    {
        use crate::segment::common::rocksdb_wrapper::DB_MAPPING_CF;
        ...
        if use_rocksdb_mutable_tracker {
            ...
            if crate::common::flags::feature_flags().migrate_rocksdb_id_tracker {
...
pub fn load_segment(
    ...
    #[cfg(feature = "rocksdb")]
    {
        if crate::common::flags::feature_flags().migrate_rocksdb_vector_storage {
        ...
        if crate::common::flags::feature_flags().migrate_rocksdb_payload_storage {
...
pub fn migrate_rocksdb_dense_vector_storage_to_mmap(
    ...
    use crate::segment::vector_storage::Sequential;
    use crate::segment::vector_storage::dense::appendable_dense_vector_storage::find_storage_files;
...
pub fn migrate_rocksdb_multi_dense_vector_storage_to_mmap(
    ...
    use crate::segment::vector_storage::Sequential;
    use crate::segment::vector_storage::multi_dense::appendable_mmap_multi_dense_vector_storage::find_storage_files;
...
pub fn migrate_rocksdb_sparse_vector_storage_to_mmap(
    ...
    use crate::segment::vector_storage::Sequential;
    use crate::segment::vector_storage::sparse::mmap_sparse_vector_storage::find_storage_files;
...
pub fn migrate_rocksdb_payload_storage_to_mmap(
    ...
    use crate::segment::payload_storage::{PayloadStorage, mmap_payload_storage};
