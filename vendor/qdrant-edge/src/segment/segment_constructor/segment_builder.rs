...
use crate::segment::id_tracker::{IdTracker, IdTrackerEnum, for_each_unique_point};
...
use crate::segment::index::{PayloadIndex, VectorIndexEnum};
...
use crate::segment::segment_constructor::batched_reader::{BatchedVectorReader, PointData};
...
impl SegmentBuilder {
    ...
    pub fn build_for_test(self, segments_path: &Path) -> Segment {
        use crate::segment::index::hnsw_index::num_rayon_threads;
