...
use crate::api::grpc::qdrant as grpc;
use crate::api::grpc::vector::Vector;
...
impl TryFrom<rest::VectorStructOutput> for grpc::VectorsOutput {
    ...
    fn try_from(
        vector_struct: crate::api::rest::schema::VectorStructOutput,
    ) -> Result<Self, Self::Error> {
        let vectors = match vector_struct {
            crate::api::rest::schema::VectorStructOutput::Single(dense) => {
            ...
            crate::api::rest::schema::VectorStructOutput::MultiDense(vector) => {
            ...
            crate::api::rest::schema::VectorStructOutput::Named(vectors) => {
        ...
        if let Some(vector) = vector {
            return match vector {
                ...
                grpc::vector::Vector::Sparse(sparse) => Ok(rest::Vector::Sparse(
                    crate::sparse::common::sparse_vector::SparseVector::from(sparse),
                )),
                grpc::vector::Vector::MultiDense(multi) => {
                    let grpc::MultiDenseVector { vectors } = multi;
...
impl From<VectorInternal> for grpc::RawVector {
    fn from(value: VectorInternal) -> Self {
        use crate::api::grpc::qdrant::raw_vector::Variant;
    ...
    fn try_from(value: grpc::RawVector) -> Result<Self, Self::Error> {
        ...
        let vector = match variant {
            ...
            Variant::Sparse(sparse) => {
                VectorInternal::Sparse(crate::sparse::common::sparse_vector::SparseVector::from(sparse))
            }
