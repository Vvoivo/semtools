...
use crate::api::grpc::qdrant::value::Kind;
use crate::api::grpc::qdrant::{ListValue, Struct, Value};

pub fn payload_to_proto(payload: crate::segment::types::Payload) -> HashMap<String, Value> {
    payload
        .into_iter()
...
pub fn proto_to_payloads(proto: HashMap<String, Value>) -> Result<crate::segment::types::Payload, Status> {
    proto
        .into_iter()
        .map(|(k, v)| proto_to_json(v).map(|json| (k, json)))
        .collect::<Result<serde_json::Map<_, _>, _>>()
        .map(crate::segment::types::Payload)
}
...
mod tests {
    ...
    use super::*;
    use crate::api::grpc::qdrant::value::Kind;
    use crate::api::grpc::qdrant::{Struct, Value};
    ...
    fn test_proto_payload() {
        ...
        let payload = crate::segment::types::Payload(payload);
