...
use crate::segment::data_types::order_by::OrderBy;
...
use crate::api::grpc;
use crate::api::rest::models::InferenceUsage;
use crate::api::rest::{DenseVector, NamedVectorStruct};
    ...
    fn from(value: Vector) -> Self {
        match value {
            ...
            Vector::MultiDense(vectors) => VectorInternal::MultiDense(
                crate::segment::data_types::vectors::MultiDenseVectorInternal::new_unchecked(vectors),
            ),
...
impl From<crate::segment::types::ScoredPoint> for ScoredPoint {
    fn from(value: crate::segment::types::ScoredPoint) -> Self {
...
impl From<NamedVectorStruct> for crate::segment::data_types::vectors::NamedVectorStruct {
    fn from(value: NamedVectorStruct) -> Self {
        match value {
            NamedVectorStruct::Default(vector) => {
                crate::segment::data_types::vectors::NamedVectorStruct::Default(vector)
            }
            NamedVectorStruct::Dense(vector) => {
                crate::segment::data_types::vectors::NamedVectorStruct::Dense(vector)
            }
            NamedVectorStruct::Sparse(vector) => {
                crate::segment::data_types::vectors::NamedVectorStruct::Sparse(vector)
            }
        }
    }
}
...
impl From<crate::segment::data_types::vectors::NamedVector> for NamedVectorStruct {
    fn from(v: crate::segment::data_types::vectors::NamedVector) -> Self {
...
impl From<crate::segment::data_types::facets::FacetValue> for FacetValue {
    fn from(value: crate::segment::data_types::facets::FacetValue) -> Self {
        match value {
            crate::segment::data_types::facets::FacetValue::Keyword(keyword) => Self::String(keyword),
            crate::segment::data_types::facets::FacetValue::Int(integer) => Self::Integer(integer),
            crate::segment::data_types::facets::FacetValue::Uuid(uuid_int) => {
                Self::String(Uuid::from_u128(uuid_int).to_string())
            }
            crate::segment::data_types::facets::FacetValue::Bool(b) => Self::Bool(b),
        }
    }
}

impl From<crate::segment::data_types::facets::FacetValueHit> for FacetValueHit {
    fn from(value: crate::segment::data_types::facets::FacetValueHit) -> Self {
        let crate::segment::data_types::facets::FacetValueHit { value, count } = value;
        Self {
...
impl From<crate::segment::data_types::facets::FacetResponse> for FacetResponse {
    fn from(value: crate::segment::data_types::facets::FacetResponse) -> Self {
        let crate::segment::data_types::facets::FacetResponse { hits } = value;
        Self {
...
impl From<FacetRequestInternal> for crate::segment::data_types::facets::FacetParams {
