...
use crate::segment::common::utils::MaybeOneOrMany;
use crate::segment::data_types::index::{StemmingAlgorithm, StopwordsInterface, TokenizerType};
...
use crate::api::rest::validate::validate_relevance_feedback_input;

/// Type for dense vector
pub type DenseVector = Vec<crate::segment::data_types::vectors::VectorElementType>;
...
impl Validate for VectorStruct {
    fn validate(&self) -> Result<(), validator::ValidationErrors> {
        match self {
            ...
            VectorStruct::Named(v) => crate::common::validation::validate_iter(v.values()),
...
fn version_example() -> crate::segment::types::SeqNumberType {
    3
}

fn score_example() -> crate::common::types::ScoreType {
    0.75
}
...
pub struct ScoredPoint {
    ...
    pub version: crate::segment::types::SeqNumberType,
    /// Points vector distance to the query vector
    #[schemars(example = "score_example")]
    pub score: ScoreType,
    /// Payload - values assigned to the point
    #[serde(skip_serializing_if = "Option::is_none")]
    pub payload: Option<crate::segment::types::Payload>,
    /// Vector of the point
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    /// Order-by value
    #[serde(skip_serializing_if = "Option::is_none")]
    pub order_value: Option<crate::segment::data_types::order_by::OrderValue>,
}
...
pub struct Record {
    /// Id of the point
    pub id: crate::segment::types::PointIdType,
    /// Payload - values assigned to the point
    #[serde(skip_serializing_if = "Option::is_none")]
    pub payload: Option<crate::segment::types::Payload>,
    /// Vector of the point
    ...
    /// Shard Key
    #[serde(skip_serializing_if = "Option::is_none")]
    pub shard_key: Option<crate::segment::types::ShardKey>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub order_value: Option<crate::segment::data_types::order_by::OrderValue>,
}
...
pub enum NamedVectorStruct {
    Default(crate::segment::data_types::vectors::DenseVector),
    Dense(crate::segment::data_types::vectors::NamedVector),
    Sparse(crate::segment::data_types::vectors::NamedSparseVector),
...
pub enum VectorInput {
    ...
    Id(crate::segment::types::PointIdType),
    Document(Document),
    Image(Image),
    Object(InferenceObject),
}
