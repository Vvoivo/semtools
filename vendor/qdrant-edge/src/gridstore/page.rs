...
use crate::common::mmap::create_and_ensure_length;
use crate::common::universal_io::mmap::MmapUniversal;
use crate::common::universal_io::{ElementsRange, Flusher, UniversalRead, UniversalWrite};
use fs_err as fs;

use crate::gridstore::Result;
use crate::gridstore::error::GridstoreError;
use crate::gridstore::tracker::BlockOffset;
...
impl Page<MmapUniversal<u8>> {
    ...
    pub fn new(path: &Path, size: usize) -> Result<Self> {
        ...
        let file_access = MmapUniversal::open(
            path,
            crate::common::universal_io::OpenOptions {
...
impl<S: UniversalRead<u8>> Page<S> {
    ...
    pub fn read_value<const READ_SEQUENTIAL: bool>(
        ...
        let page_len = self.file_access.len()?;
