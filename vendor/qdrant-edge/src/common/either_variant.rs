...
macro_rules! for_all {
    ($value:expr, $pattern:pat => $result:expr) => {
        match $value {
            $crate::common::either_variant::EitherVariant::A($pattern) => $result,
            $crate::common::either_variant::EitherVariant::B($pattern) => $result,
            $crate::common::either_variant::EitherVariant::C($pattern) => $result,
            $crate::common::either_variant::EitherVariant::D($pattern) => $result,
        }
    };
}
